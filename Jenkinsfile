pipeline {
  ...
  environment {
    awsecrRegistry = '389579302079.dkr.ecr.us-east-1.amazonaws.com/ecr-repo-ue1-bhj1-dev'
    awsecrRegistryCredentail = 'da69b5e8-a6f0-4763-82f8-25fadbeb7c49'
    githubCredential = 'vture0325'
    gitEmail = 'vture0325@gmail.com'
    gitName = 'vture0325'
  }
  ...
  stages {
    ...
    stage('Checkout Application Git Branch') {
      steps {
        checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: githubCredential, url: 'https://github.com/vture0325/mini-cicd-eks-project.git']]])
      }
      // steps 가 끝날 경우 실행한다.
    ...
    stage('Deploy') { 
      steps {
        ...
        git credentialsId: githubCredential,
            url: 'https://github.com/vture0325/mini-cicd-eks-project.git',
            branch: 'main'  
        /*
